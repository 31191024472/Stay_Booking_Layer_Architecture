/**
 * Component HotelViewCardSkeleton
 * Hiển thị khung xương cho thẻ xem thông tin khách sạn khi đang tải dữ liệu.
 * Sử dụng hiệu ứng pulse để tạo cảm giác đang tải.
 *
 * @returns {JSX.Element} Component HotelViewCardSkeleton
 */

 ...
 * Hiển thị nút dropdown với menu thả xuống.
 *
 * @param {Object} props - Props của component.
 * @param {string} props.triggerType - Loại kích hoạt dropdown ('click' hoặc 'hover').
 * @param {string} props.color - Màu nền của nút dropdown.
 * @param {Array} props.options - Danh sách các tùy chọn trong menu dropdown.
 * @returns {JSX.Element} Component DropdownButton
 */

...
/**
 * Component Tabs
 * Hiển thị giao diện tab với các tab có thể chuyển đổi.
 *
 * @param {Object} props - Props của component.
 * @param {React.ReactNode} props.children - Các tab con.
 * @param {boolean} props.isTabsVisible - Trạng thái hiển thị của các tab.
 * @param {React.RefObject} props.wrapperRef - Tham chiếu đến phần tử bao bọc.
 * @returns {JSX.Element} Component Tabs
 */

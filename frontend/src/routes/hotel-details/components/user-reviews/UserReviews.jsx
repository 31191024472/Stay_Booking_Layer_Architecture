...
/**
* Hiển thị thành phần đánh giá của người dùng.
*
* @component
* @param {Object} reviewData - Đối tượng dữ liệu đánh giá.
* @returns {JSX.Element} Thành phần đánh giá của người dùng.
*/
...
const UserReviews = ({
  ...
  /**
* Xử lý xếp hạng người dùng đã chọn.
* @param {number} rate - Giá trị xếp hạng.
*/

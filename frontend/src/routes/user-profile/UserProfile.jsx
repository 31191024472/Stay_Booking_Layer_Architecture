...
/**
* UserProfile
* Hiển thị trang hồ sơ người dùng với các tab cho thông tin cá nhân, đặt chỗ và phương thức thanh toán.
* @returns {JSX.Element} - Thành phần UserProfile
* */
...
const UserProfile = () => {
  ...
  // Lấy dữ liệu đặt chỗ của người dùng
  ...
  // Lấy dữ liệu phương thức thanh toán của người dùng
  ...
  // hiệu ứng để thiết lập trạng thái ban đầu của dữ liệu đặt chỗ của người dùng
  useEffect(() => {

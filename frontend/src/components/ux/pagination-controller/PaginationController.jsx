...
/**
 * Thành phần PaginationController để phân trang kết quả tìm kiếm.
 * @param {Object} props - Các thuộc tính của component.
 * @param {number} props.currentPage - Số trang hiện tại.
 * @param {number} props.totalPages - Tổng số trang.
 * @param {Function} props.handlePageChange - Hàm xử lý khi thay đổi trang.
 * @param {Function} props.handlePreviousPageChange - Hàm xử lý khi chuyển về trang trước.
 * @param {Function} props.handleNextPageChange - Hàm xử lý khi chuyển sang trang tiếp theo.
 *
 * @returns {JSX.Element} Thành phần giao diện được hiển thị.
 *
 * @example
 * return (
